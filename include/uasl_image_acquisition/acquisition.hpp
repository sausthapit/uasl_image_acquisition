...
class Acquisition
{
    ...
    int64_t timestamp; // time since origin_tp, expressed in microseconds. This is updated after each successful acquisition. Note this variable is protected by the mutex images_ready_mtx
